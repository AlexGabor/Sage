...
import com.alexgabor.commonui.screen.RecipeDetailScreen
import com.alexgabor.commonui.screen.RecipeListScreen
...
fun RecipeDetailScreen(pathname: String?, onNotFound: () -> Unit) {
    ...
    val recipes: List<com.alexgabor.common.model.Recipe> by getRecipes.recipes.collectAsState()
